...
import 'package:wb_sweet_sweat/gen/assets.gen.dart';

class MapStyleService {
  static Future<String> getMapStyle({bool isDarkMode = false}) async {
    return await rootBundle.loadString(
      isDarkMode ? Assets.mapStyles.dark : Assets.mapStyles.light,
    );
  }

  static Future<BitmapDescriptor> getMyLocationMarkerIcon() async {
    return await BitmapDescriptor.fromAssetImage(
        const ImageConfiguration(), Assets.images.icons.deliveryIcon64x64.path);
  }
